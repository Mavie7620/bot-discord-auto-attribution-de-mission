...
# Serveurs déverrouillés : en mémoire uniquement -> tout se reverrouille à chaque redémarrage
...
async def on_ready():
    ...
    # Verrouillage systématique de tous les serveurs à chaque redémarrage
